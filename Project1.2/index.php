...
<body>
    ...
    <div class="container">
        <form id="viewAllMoviesForm" method="post" action="movies.php">
            <button class="btn btn-primary" type="submit" name="viewAllMovies">View All Movies</button>
        </form>
    </div>
    <div class="container">
        <form id="viewAllMoviesForm" method="post" action="actors.php">
            <button class="btn btn-primary" type="submit" name="viewAllMovies">View All Actors</button>
        </form>
    </div>
